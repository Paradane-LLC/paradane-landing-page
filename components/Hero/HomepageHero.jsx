...
const HomepageHero = () => {
    return (
        <div className="relative min-h-screen">
            ...
            {/* Overlay */}
            <div className="absolute inset-0 bg-[#00489c]/80 text-white min-h-screen flex items-center z-10 pt-16 md:pt-20">
                <div className="max-w-7xl mx-auto w-full">
                    <div className="flex flex-col gap-8 max-w-2xl">
                        <div className="flex flex-col">
                            <span className="text-4xl sm:text-6xl font-semibold text-white/80 leading-tight">
                                We engineer intelligent & modern software for{" "}
                                <span className="font-bold text-white">the digital era</span>.
                            </span>
                        </div>
                        <button className="relative hover:scale-105 text-lg sm:text-xl text-[#00489c] font-semibold bg-white px-5 py-2 rounded-lg max-w-fit cursor-pointer transition-all z-10">
            ...
            <div className="absolute left-0 right-0 bottom-32 max-w-7xl mx-auto w-full z-10 px-4">
                <div className="text-white font-semibold text-2xl sm:text-4xl leading-snug">
