...
const ServiceItem = ({label, description, href, icon: Icon}) => {
    return (
        <Link
            className="flex flex-col gap-3 bg-white rounded-3xl px-5 py-5 shadow-lg backdrop-blur cursor-pointer overflow-hidden relative z-10 group hover:scale-105 transition-all"
            href={href}
        >
            <div className="flex">
            ...
            <span className="text-base text-zinc-700 group-hover:text-black block mt-2">
                {description}
            </span>
